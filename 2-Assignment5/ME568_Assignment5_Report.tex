...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item not sure on characteristic velocity scale -- not mean velocity, maybe use relation between mean flow scales and turbulent scales: $\ell/L \sim u/U$ and $\ell/u \sim L/U$?
